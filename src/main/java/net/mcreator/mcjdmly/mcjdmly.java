 ...
 *
 *    Keep the Elementsmcjdmly object in this class and all calls to this object
...
public class mcjdmly {
	public static final String MODID = "mcjdmly";
	public static final String VERSION = "0.2";
	public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("mcjdmly");
	@SidedProxy(clientSide = "net.mcreator.mcjdmly.ClientProxymcjdmly", serverSide = "net.mcreator.mcjdmly.ServerProxymcjdmly")
	public static IProxymcjdmly proxy;
	@Mod.Instance(MODID)
	public static mcjdmly instance;
	public Elementsmcjdmly elements = new Elementsmcjdmly();
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new Elementsmcjdmly.GuiHandler());
